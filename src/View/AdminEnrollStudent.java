...
public class AdminEnrollStudent extends JPanel{
	...
	public AdminEnrollStudent(AdminFrame frame)
	{	
		this.frame=frame;
		this.setLayout(null);
		this.setBackground(new Color(115, 153, 0));
		addComponentToPanel();
	}
	...
	public void addComponentToPanel() 
	{
		...
		this.Enroll=new JButton("Enroll");
		this.Sas=new JButton("Student List");
		...
		Username.setBounds(10,260,100,50);
		username.setBounds(150,260,200,50);
		
		Password.setBounds(10,310,100,50);
		password.setBounds(150,310,200,50);
		
		Choosefile.setBounds(10,380,200,30);
		choosefile.setBounds(210,380,130,30);
		
		
		Enroll.setBounds(65, 445, 90, 50);
		Sas.setBounds(170,445,115,50);
		
		id.setToolTipText("Example : 3-**");
		...
		Enroll.addActionListener( new ActionListener(){
			...
			public void actionPerformed(ActionEvent e)
			{	
				if(name.getText().equals("") || dob.getText().equals("") || email.getText().equals("") || id.getText().equals("") || level.getText().equals("") || username.getText().equals("") || password.getText().equals("") )
				{
				...
				int flag=0;
				 ...
				 if(flag==0) 
				 {
					 	Admin.enrollStudent(name.getText(), dob.getText(), email.getText(), id.getText(), level.getText(), username.getText(), password.getText(),Choosefile.getText(), "student" );
					 	name.setText("");
					 	dob.setText("");
					 	email.setText("");
					 	id.setText("");
		...
		Sas.addActionListener( new ActionListener(){
			...
			public void actionPerformed(ActionEvent e){
				...
				ArrayList<Student> list = frame.admin.studentList();
				String columns [] = {"Name","DOB","Email","ID","Level","Username","Password"};//,"Type"};
				...
				{	
					...
					data[i][4] = list.get(i).getLevel();
					data[i][5] = list.get(i).getUn();
					data[i][6] = list.get(i).getPass();
				}
					

					 JFrame jf = new JFrame("Student List");
			         jf.setSize(700, 500);
			         jf.setVisible(true);
